...
namespace Feature.Player
{
    public class PlayerInstaller : MonoInstaller
    {
        ...
        public override void InstallBindings()
        {
            ...
            Container.Bind<CharacterControllerLocomotion.Settings>().FromInstance(_mineConfig.LocomotionSettings);
    ...
    public class MineConfig: ScriptableObject
    {
        ...
        [field: SerializeField] public CharacterControllerLocomotion.Settings LocomotionSettings {get; private set;}
